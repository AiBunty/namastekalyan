/**
 * NK Admin SPA Module: App Settings
  ...
  NK.MODULES['settings'] = {
    ...
    init: function (container, authClient) {
      ...
      container.innerHTML = '<style>'
        ...
        + '<div class="stg-header"><h2>App Settings</h2><p class="stg-subtitle">Manage WhatsApp number and Menu Blocker passcode</p></div>'
      ...
      form.addEventListener('submit', function (e) {
        ...
        if (!whatsappNo || !staffCode) { showAlert('Please fill in all fields.', 'error'); return; }
        saveBtn.disabled = true;

        authClient.apiPost({
          action: 'auth_set_app_settings',
          settings: { hotelWhatsappNo: whatsappNo, menuBlockerStaffCode: staffCode }
        })
          .then(function (data) {
