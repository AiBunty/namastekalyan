  ...
  NK.MODULES['landing-routing'] = {
    ...
    init: function (container, authClient) {
      ...
      container.innerHTML = ''
        ...
        + '@media(max-width:900px){.lrm-grid,.lrm-row{grid-template-columns:1fr}}'
        + '</style>'
        + '<div class="lrm-shell">'
        + '  <div class="lrm-hero">'
        + '    <h2>Landing Routing Control</h2>'
        + '    <p>Control blocker placement and manage reusable QR redirects from one place. Each QR gets a stable slug URL, and each slug can point to a core page, an active event page, or a manual target URL.</p>'
        + '  </div>'
